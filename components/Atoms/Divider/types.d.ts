export declare const DIVIDER_DARK = "dark";
export declare const DIVIDER_LIGHT = "light";
export declare const DIVIDER_HORIZONTAL = "horizontal";
export declare const DIVIDER_VERTICAL = "vertical";
export declare const DIVIDER_CONTRAST_HIGH = "high";
export declare const DIVIDER_CONTRAST_MEDIUM = "medium";
export declare const DIVIDER_CONTRAST_LOW = "low";
