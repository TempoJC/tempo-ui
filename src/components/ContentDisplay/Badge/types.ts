...
export interface BadgeProps {
   ...
   */
  variant?:
    | typeof BADGE_COLOR_COCONUT
    | typeof BADGE_COLOR_BLACKBERRY
    | typeof BADGE_COLOR_CHERRY
    | typeof BADGE_COLOR_APRICOT
    | typeof BADGE_COLOR_KIWI
    | typeof BADGE_COLOR_MINT
    | typeof BADGE_COLOR_WATER
    | typeof BADGE_COLOR_BLUEBERRY
    | typeof BADGE_COLOR_GRAPE
    | typeof BADGE_COLOR_WATERMELON;
